		...
		if(presence == "active"){
			...
			checkStatusWait = setInterval(function(){
				if(checkStatus != "NULL"){
					...
					slotStatus(slot_status,slotTimeSec,credit_status,currentTime,creditTime,totalTime)
				}
...
function slotStatus(slot,slotTimeSec,slotCredit,currentTime,creditTime,totalTime){		
	if(slot == "available"){
